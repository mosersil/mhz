...
public class EnvironmentConfiguration {
    ...
    public RegistrationConfiguration registrationConfiguration() {
        final RegistrationConfiguration registrationConfiguration = new RegistrationConfiguration();
        registrationConfiguration.setBaseUrl(environment.getProperty("register.baseurl"));
        registrationConfiguration.setEmailFrom(environment.getProperty("register.emailfrom"));
