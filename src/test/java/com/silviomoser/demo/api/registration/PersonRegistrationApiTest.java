...
public class PersonRegistrationApiTest extends AbstractTestNGSpringContextTests {
    ...
    public void registerPersonTest() {
        PersonRegistrationDataSubmission personRegistrationDataSubmission = buildPersonRegistrationDataSubmission("male", "Max", "Muster", "Fake Street", "Mailbox", "5555", "Lyton", "max_muster@localhost.com",STRONG_PASSWORD, STRONG_PASSWORD, PREFERED_CHANNEL);
    ...
    private PersonRegistrationDataSubmission buildPersonRegistrationDataSubmission(String gender, String firstName, String lastName,
        ...
        personRegistrationDataSubmission.setPreferedChannel(preferedChannel);
